...
- [THEA MMP attribution platform](thea-mmp-platform.md) — mmpi_ ingest tokens (NOT thea_ keys), per-app stable ipSalt fingerprint ≤7d, idempotent installs, appId filter on every stats aggregate
